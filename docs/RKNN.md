...
- 板端：pip install docs/rknn-toolkit2/rknn_toolkit2-2.3.2-cp310-cp310-manylinux_2_17_aarch64.manylinux2014_aarch64.whl (仅转换模型使用)
...
- RKNN模型量化时，不支持动态输入，dynamic_input必须为None
