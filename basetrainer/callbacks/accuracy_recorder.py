...
from basetrainer.callbacks import callbacks
from basetrainer.metric.eval_tools import classification_report
from basetrainer.utils import log, file_utils
...
class AccuracyRecorder(callbacks.Callback):
    ...
    def on_test_end(self, logs: dict = {}):
        if len(self.pred_labels) == 0: return
